  ...
  \chapter{Interface}
	...
	% ? -> Raccourcis : opérationnels ??
	  ...
	  \paragraph{}
	    ...
	    Il présente également une fonction d'export, notamment pour le calendrier généré. Cette fonction exporte le planning des soutenances au formatx PDF, ou encore ICS, qui permet la compatibilité avec les calendriers Google notamment.
