  ...
  \chapter{Interface}
	...
	\section{Le menu}
	  ...
	  \paragraph{}
	    ...
	    La troisième fonctionnalité rend possible la réinitialisation complète de la base de données.
	    Activer cette option efface la base de données, et en crée une nouvelle, vide.
