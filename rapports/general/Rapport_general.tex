  ...
  \chapter{Interface}
	...
	% ? -> Raccourcis : opérationnels ??
	  ...
	  \paragraph{}
	    ...
	    Enfin, un dernier lien permet de modifier la liste des salles de présentation des soutenances. 
	  ...
	  ~\\~\\
		...
		En cliquant sur un des éléments de cette liste , toutes les informations relatives à la soutenance de cet étudiant, à savoir le tuteur, l'enseignant et la salle de la soutenance, apparaissent dans le coin inférieur gauche de l'écran.
