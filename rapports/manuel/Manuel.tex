...
\part{La gestion des stages}
	...
	\renewcommand\labelitemi{\textbullet}
	  \begin{itemize}
	    \item Si vous n'avez aucun fichier possédant cet extension, il est très simple d'en créer en utilisant par exemple un logiciel de tableur.
		  ...
		  Pour enregistrer ce fichier au format CSV, cliquer sur ``Fichier - Enregistrer sous...'', entrez le nom de votre fichier, puis cliquez sur ``Tous les formats'' et choisissez ``Fichier CSV''.
	...
	\paragraph{}
	  ...
	  ~\\~\\
	\begin{figure}[!h]
	      \hbox to11cm{\hss\includegraphics[width=7cm]{../general/import.png}\hss}
	      \caption{Import de fichier CSV}
	\end{figure}
	...
	~\\~\\~\\~\\~\\~\\~\\~\\~\\
	\begin{figure}[!h]
	      \hbox to12cm{\hss\includegraphics[width=14cm]{../general/valider_gris.png}\hss}
	      \caption{Accueil après imports}
	\end{figure}
