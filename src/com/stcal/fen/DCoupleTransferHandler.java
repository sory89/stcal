        ...
        try {
           ...
           jt=table;
            ...
            Datas.stages.removeElement(dc);  }
                 ...
                 Message.err.println("Erreur : Le nombre de soutenances dans ce creneau est au maximum.");
             }
            }
            else{
                Message.err.println("Erreur : Ce professeur est déjà présent à ce créneau.");
            }
            int i;
            int y;
